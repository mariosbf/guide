...
\newcommand{\lectureSixTopics}{Higher-order functions such as \texttt{map}, \texttt{filter}, etc., recursion primitives such as \texttt{foldr} and \texttt{foldl}.}
...
\newcommand{\lectureThirteenTopics}{\texttt{Foldable} type class, its motivation, and examples.}
...
\newcommand{\lectureFourteenTopics}{Some functions for the sequential composition of \texttt{Maybe} values.}
...
\newcommand{\lectureFifteenTopics}{Some functions for the sequential composition of \texttt{State} values and some laws for sequential composition.}
...
\newcommand{\lectureSeventeenTopics}{The \texttt{IO} monad.}
...
\newcommand{\lectureEighteenBTopics}{The \texttt{IO} monad in action.}
...
\newcommand{\practicalEightAims}{You will write programs using monads, define your own instances of the \texttt{Monad} type class, and reason about monad laws.}
