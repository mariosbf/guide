...
\task{You may again wish to convince yourself that your implementation of \haskellIn{fmap} for this type obeys the functor laws.}
...
\task{You may once again wish to verify that your instance of \haskellIn{Functor} for \texttt{\small Point} obeys the functor laws.}
...
\task{Proving that \haskellIn{fmap} for \texttt{\small Compose} obeys the functor laws is significantly more interesting than for the previous types. Can you do it? \emph{Hint}: you need to assume that the two underlying functors obey the laws and make use of them.}
