...
These exercises are about foldables, \emph{i.e.} data structures for which we can implement \haskellIn{foldr}. As usual, you can obtain the skeleton code for this lab by cloning the respective repository from GitHub:
\begin{minted}{bash}
