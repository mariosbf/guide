...
\task{Open the \texttt{\small src/Lab1.hs} file and modify the definitions of \haskellIn{age} and \haskellIn{name} to match your name and age.}
...
\begin{tabular}{|l|l|}
\hline 
    \texttt{:q}   & Quits the REPL. \\ 
\hline 
    \texttt{:r}  & Reloads all files that are currently loaded. \\ 
\hline 
    \texttt{:l FILENAME} & Loads \texttt{FILENAME} into the REPL. \\
\hline
\end{tabular} 
\end{center}
