...
\paragraph{Visual Studio Code} Visual Studio Code is the text editor I would recommend and that I am currently using. The \bashIn{/modules/cs141/haskell-setup.sh} script on the departmental machines already installs the following plugins for you:
\begin{itemize}
